...
export default function RequirementStatus({ post, currentUser, compact = false }) {
  ...
  return (
    <div ref={rootRef} className={styles.root}>
      ...
      {open && (
        <>
        <button type="button" className={styles.backdrop} onClick={() => setOpen(false)} aria-label="Close requirement status" />
        <div className={`${styles.popover} ${compact ? styles.alignRight : ''}`}>
          <div className={styles.mobileHeading}><strong>Requirement status</strong><button type="button" onClick={() => setOpen(false)} aria-label="Close">x</button></div>
