...
export default function ComboSticker({ inline = false }) {
  ...
  return (
    <>
      ...
      >
        <div className={`relative transition-transform duration-300 w-[280px] scale-[0.6] sm:scale-[0.8] md:scale-100 origin-bottom-right md:origin-top-right ${!isEditMode ? 'hover:scale-105 cursor-pointer' : ''}`}
